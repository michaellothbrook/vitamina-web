  ...
  module: {
    rules: [
      ...
      },
      {
        ...
        loader: 'url-loader',
        options: {
          limit: 8192, // Limite de tamanho em bytes para a conversão em base64
          name: 'images/[name].[ext]', // Caminho e nome do arquivo de saída
        },
      },
      {
        ...
        loader: 'file-loader',
        options: {
          name: 'fonts/[name].[ext]', // Caminho e nome do arquivo de saída
        },
      },
    ],
  },
 ...
 */
module.exports = merge.smart(webpackConfig, desire(`${__dirname}/webpack.config.preset`));
